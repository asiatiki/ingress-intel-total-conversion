...
// @updateURL      none
// @downloadURL    none
// @description    [local-2013-07-12-061928] Uses the fill color of the portals to denote if the portal is weak (Needs recharging, missing a resonator, needs mods)  Red, needs energy and mods. Orange, only needs energy (either recharge or resonators). Yellow, only needs mods.
