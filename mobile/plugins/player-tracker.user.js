...
// @updateURL      none
// @downloadURL    none
// @description    [mobile-2013-05-20-045447] Draws trails for the path a user went onto the map. Draws up to three hours. Does not request chat data on its own, even if that would be useful.
